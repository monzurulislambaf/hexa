        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              A premier engineering consultancy firm in Bangladesh dedicated to
              transforming the industrial landscape through energy efficiency,
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="text-sm text-gray-400">
                  ...
                  {SITE_CONFIG.address.branchOffice.address}
                </div>
              </li>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} Hexa Engineering Limited. All rights reserved.
          </p>
